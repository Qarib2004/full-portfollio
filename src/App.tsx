  ...
  return (
    <div
      style={{
        ...
        fontSize: 13,
        overflow: "hidden",
        boxShadow: "0 0 30px #00ff8820, inset 0 0 30px rgba(0,0,0,0.5)",
      }}
    >
      <div
        style={{
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <span
            style={{ fontFamily: "monospace", fontSize: 12, color: "#475569" }}
          >
    ...
    <span
      ...
      onMouseEnter={(e) => {
        (e.currentTarget as HTMLElement).style.background =
          "rgba(0,255,136,0.12)";
        (e.currentTarget as HTMLElement).style.boxShadow = "0 0 12px #00ff8840";
      }}
      onMouseLeave={(e) => {
        (e.currentTarget as HTMLElement).style.background =
          "rgba(0,255,136,0.04)";
  ...
  return (
    ...
    >
      ...
      {project.deploy && (
        ...
        >
          <span style={{ color: "#334155" }}>deploy: </span>
          {project.deploy}
        </div>
      )}
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
        ...
        {hasImages && onViewImages && (
          <button
            onClick={() => onViewImages(project.title)}
            style={{
              display: "flex",
              alignItems: "center",
              gap: 6,
...
export default function App() {
  ...
  const projects: Project[] = [
    ...
    },
    {
      title: "FoodGo",
      description:
        "Users can add restaurants and food items to favorites, add food to basket, and leave reviews.",
      tech: [
        "Next.js",
        "PostgreSQL",
        "Zustand",
    ...
    },
    {
      title: "ESSENCE",
      description:
        "AI-powered perfume store with image recognition search, Stripe payments, and full-stack architecture.",
      tech: [
        "Next.js",
  ...
  const terminalLines: TerminalLine[] = [
    {
      text: "Qarib Alisultanov — Fullstack Developer",
      prompt: true,
      color: "#00ff88",
    },
    { text: "Location: Baku, Azerbaijan", prompt: false, color: "#64748b" },
    {
      text: "Stack: React · Next.js · NestJS · Node.js · PostgreSQL",
      prompt: false,
      color: "#0ea5e9",
    },
  ];
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ animation: "glow 3s ease-in-out infinite" }}>
              QA
            </span>
      ...
      >
        <div
          style={{
            ...
            height: 1,
            background:
              "linear-gradient(90deg, transparent, #00ff8830, transparent)",
            top: `${scanLine}%`,
            pointerEvents: "none",
          }}
        />
        ...
        <div
          style={{
            ...
            width: 40,
            height: 40,
            borderTop: "1px solid #00ff8830",
            borderLeft: "1px solid #00ff8830",
          }}
        />
        <div
          style={{
            ...
            height: 40,
            borderTop: "1px solid #00ff8830",
            borderRight: "1px solid #00ff8830",
          }}
        />
        <div
          style={{
        ...
        >
          ...
          >
            <TypeWriter
              text="fullstack engineer · building scalable digital experiences"
              speed={50}
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div className="about-grid">
            <div>
              ...
              >
                <span style={{ color: "#334155" }}>// </span>
                Passionate fullstack developer studying Information Technology
                at Azerbaijan University of Architecture and Construction. I
                build full-stack applications from the ground up — both client
                and server — with attention to performance, architecture, and
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              {[
                {
                  label: "education",
                  value: "Code Academy — Software Engineering (MERN)",
                  icon: "📚",
                  color: "#0ea5e9",
                },
                {
                  label: "location",
                  value: "Yasamal, Baku, Azerbaijan 🇦🇿",
                  icon: "📍",
                  color: "#00ff88",
                },
                {
                  label: "commitment",
                  value: "100% — always pushing to learn more",
                  icon: "⚡",
                  color: "#a855f7",
                },
                {
                  label: "focus",
                  value: "Scalable web apps, clean architecture, DX",
                  icon: "🎯",
                  color: "#f59e0b",
                },
      ...
      <section
        id="skills"
        style={{ background: "#020617", padding: "80px 20px" }}
        className="grid-bg"
      >
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ marginBottom: 48 }}>
            ...
            <h2 className="section-title">
              <span style={{ color: "#0ea5e9" }}>tech_stack</span>
            </h2>
            <div
              style={{
                width: 60,
            ...
            {[
              {
                ...
                color: "#00ff88",
                icon: "⬡",
                desc: "Client-side interfaces & UX",
              },
              {
                title: "backend",
              ...
              >
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                  {sk.map((name, i) => (
                    <SkillChip key={name} name={name} delay={i * 60} />
                  ))}
                </div>
              </div>
            ))}
      ...
      >
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ marginBottom: 48 }}>
            ...
            <h2 className="section-title">
              <span style={{ color: "#a855f7" }}>featured_work</span>
            </h2>
            <div
              style={{
                width: 60,
      ...
      >
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ marginBottom: 48 }}>
            ...
            <h2 className="section-title">
              <span style={{ color: "#f59e0b" }}>get_in_touch</span>
            </h2>
            <div
              style={{
                width: 60,
          ...
          <div className="contact-grid">
            <div>
              ...
              >
                ...
                <br />
                &nbsp;* interesting projects, or just connecting.
                <br />
                ...
                {[
                  {
                    icon: "✉",
                    label: "email",
                    value: "garibalisultanov@gmail.com",
                  ...
                  },
                  {
                    icon: "📱",
                    label: "phone",
                    value: "+994 77 611 28 88",
                    href: "tel:+994776112888",
                    color: "#0ea5e9",
                  },
                  {
                    icon: "📍",
            ...
            <div>
              <Terminal
                ...
                lines={[
                  ...
                  {
                    text: "→ GitHub: github.com/Qarib2004",
                    prompt: false,
                    color: "#00ff88",
                  },
                  {
                    text: "→ LinkedIn: Garib Alisultanov",
                    prompt: false,
                    color: "#0ea5e9",
                  },
                  {
                    text: "→ Email: garibalisultanov@gmail.com",
                    prompt: false,
                    color: "#a855f7",
                  },
                  {
                    text: "Ready. Awaiting your message...",
                    prompt: false,
                    color: "#f59e0b",
                  },
                ]}
